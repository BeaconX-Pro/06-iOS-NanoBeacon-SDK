...
@interface MKNNBAboutController ()
...
@implementation MKNNBAboutController

- (void)dealloc {
    NSLog(@"MKNNBAboutController销毁");
}
...
- (UILabel *)appNameLabel{
    if (!_appNameLabel) {
        ...
        _appNameLabel.text = @"MOKO NanoBeacon";
    }
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKNanoBeacon", @"MKNNBAboutController", @"nnb_aboutIcon.png");
    }
    return _aboutIcon;
}
